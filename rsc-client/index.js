...
// Expose mudclient globally for external instantiation
window.mudclient = mudclient;

// Only auto-initialize if there's no external control (i.e., no canvas with id 'mudclient-canvas')
if (!document.getElementById('mudclient-canvas')) {
    (async () => {
